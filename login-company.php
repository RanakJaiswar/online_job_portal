...
<div class="login-box" style="height: 20%; width: 40%;">
  ...
  <div class="login-box-body">
    <div class="pull-right">
      <a href="login.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
    </div>
    <h3 class="login-box-msg">Employer Login</h3>

    <form method="post" action="checkcompanylogin.php" style="margin-top: 20px;">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-12">
          <button type="submit" class="btn btn-primary btn-block" style="margin-top: 20px;">Sign In</button>
        </div>
        <!-- /.col -->
        <div class="col-xs-12">
        <?php 
